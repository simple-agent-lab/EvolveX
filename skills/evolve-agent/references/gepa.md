...
connects a `pareto` select, task rollout, a `gepa` trace_analyzer for component
...
Use `operators/select.py`, `operators/trace_analyzer.py`, and
...
`library/select/pareto.py`, `library/trace_analyzer/gepa.py`, and
...
4. Choose one or more components and propose an evidence-linked mutation.
