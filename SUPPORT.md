...
use its private reporting path rather than opening an issue.

Private operational help, benchmark credentials, and experiment debugging are
outside this project's public support scope.
