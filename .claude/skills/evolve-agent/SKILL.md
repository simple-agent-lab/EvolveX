...
Read and follow the [canonical skill](../../../skills/evolve-agent/SKILL.md)
before acting. Resolve every relative link and reference from the canonical
[`skills/evolve-agent` directory](../../../skills/evolve-agent/). This wrapper
provides discovery only; do not treat it as a separate workflow.
