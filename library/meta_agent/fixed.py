"""Fixed meta-agent appends a deterministic generation marker to target/agent.py.

It is the simple generated baseline for verifying checkout-local candidate edits.
"""
...
class FixedMetaAgent(MetaAgentOperator):
