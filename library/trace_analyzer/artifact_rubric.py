    ...
    def analyze(self, checkout: Path, ctx: OperatorContext) -> AnalyzeResult:
        ...
        return AnalyzeResult(
            ...
            artifacts=[
                ...
                "trace_analyzer/evidence/diagnosis.json",
                "trace_analyzer/evidence/rubric_failures.json",
                "trace_analyzer/evidence/artifact_manifest.json",
...
if __name__ == "__main__":
    sdk.main(ArtifactRubricAnalyzer)
