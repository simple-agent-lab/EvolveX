...
This recipe preserves the existing AHE method and evaluates each generation on
the 100-task training partition of Harbor's 249-task HLE parity set. The 49
gate tasks and 100 sealed tasks are not exposed to the evolutionary loop.
