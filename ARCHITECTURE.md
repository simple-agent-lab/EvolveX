...
| `runtime_environment.py` | 400 | role-specific credential, endpoint, proxy, template, and redacted Harbor environment planning |
...
Total `src/evolve/` budget: **12030 lines**. The budget admits the explicit content-backed
