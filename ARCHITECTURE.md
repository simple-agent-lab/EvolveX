...
| `frozen/sdk.py` | 375 | Python operator entrypoint and file-contract IO; no library algorithm policy |

Total `src/evolve/` budget: **18255 lines**. The budget admits the explicit content-backed
