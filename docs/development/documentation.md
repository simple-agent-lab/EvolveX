...
| Document | Role |
| --- | --- |
| [Repository README](https://github.com/simple-agent-lab/EvolveX/blob/main/README.md) | concise repository overview |
| [Quick start guide](https://github.com/simple-agent-lab/EvolveX/blob/main/QUICKSTART.md) | recipe launcher quick start and benchmark results |
