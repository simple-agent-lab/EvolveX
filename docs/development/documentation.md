...
| Document | Role |
| --- | --- |
| [Repository README](https://github.com/simple-agent-lab/simple-evolve-agent/blob/main/README.md) | concise repository overview and quick start |
...
| [Source architecture map](https://github.com/simple-agent-lab/simple-evolve-agent/blob/main/ARCHITECTURE.md) | enforced `src/evolve/` module map and budgets |
...
| [Operator interfaces](https://github.com/simple-agent-lab/simple-evolve-agent/blob/main/src/evolve/frozen/interfaces.py) | machine-readable operator contract |
